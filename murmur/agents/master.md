...
dispatch:
  ...
  tasks: [orchestrate, coordinate, spawn, decompose]
---
...
- After work that changes the codebase, delegate to the `curator` agent to refresh
  the project's knowledge base before the task is considered done.
